...
<main class="premium-body scene-container">
    ...
    <div id="scene-1" class="c-scene">
        <img src="/assets/img/teacher_learning.png" alt="Student solving problems seriously with teacher" class="bg-image">
...
<script src="/assets/js/class7-scrolly.js"></script>
