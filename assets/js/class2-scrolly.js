...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // --------------------------------------------------------
    // Fanta-Style Parallax Tracking for 11 Premium Scenes (Class 2)
    // --------------------------------------------------------
    ...
    // Faster and more confident movement symbolising growth
    const penMoves = [
        { top: 15, right: 10, rotate: 10 },    // S1
        { top: 25, right: 35, rotate: -15 },  // S2 
        { top: 35, right: 60, rotate: -30 },  // S3
        { top: 40, right: 75, rotate: 20 },   // S4
        { top: 55, right: 15, rotate: 120 },  // S5
        { top: 65, right: 40, rotate: 45 },   // S6
        { top: 75, right: 80, rotate: -25 },  // S7
        { top: 80, right: 50, rotate: 5 },    // S8
        { top: 85, right: 25, rotate: 20 },   // S9
        { top: 85, right: 10, rotate: -15 },  // S10
