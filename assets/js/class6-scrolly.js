...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // --------------------------------------------------------
    // Fanta-Style Parallax Tracking for 15 Premium Scenes (Class 6)
    // Fast, sharp, confident motion (Super 8)
    // --------------------------------------------------------
    ...
    // 15 stops mapping for Super 8 Batch Journey
    const penMoves = [
    ...
    if (typeof gsap !== 'undefined' && typeof ScrollTrigger !== 'undefined') {
        ...
        // SCENE 12: Image parallax zoom
        gsap.to("#scene-12 .bg-wrapper img", {
            scrollTrigger: { trigger: "#scene-12", start: "top bottom", end: "bottom top", scrub: true },
            y: "25%", scale: 1.15
        });
        ...
        // SCENE 14: Emotional Close Pin
        gsap.from("#scene-14 .c-title", {
            scrollTrigger: { trigger: "#scene-14", start: "top 85%", once: true },
