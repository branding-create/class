...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // --------------------------------------------------------
    // Parallax Tracking for 16 Premium Scenes (Class 7)
    // Faster, Sharper, More focused motion
    // --------------------------------------------------------
    ...
    // 16 stops mapping for Super 8 Class 7
    const penMoves = [
        ...
        { top: 95, right: 15,  rotate: -10 },  // S15
        { top: 95, right: 5,   rotate: 0 }     // S16
    ];
    ...
    const bookMoves = [
        ...
        { top: 95, right: 75, rotate: 5},     
        { top: 95, right: 80, rotate: 0 }     // S16
    ];
    ...
    // --------------------------------------------------------
    // Cinematic GSAP ScrollTriggers - Fast Array Iteration
    // --------------------------------------------------------
    if (typeof gsap !== 'undefined' && typeof ScrollTrigger !== 'undefined') {
        ...
        floats.forEach(f => {
            gsap.to(f, {
                scrollTrigger: { trigger: "#scene-4", start: "top bottom", end: "bottom top", scrub: 0.3 },
